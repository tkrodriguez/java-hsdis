...
#include "sun_jvm_hotspot_hsdis_Disassembler.h"

/*
 *  This file implements a binding between Java and the hsdis
 *  dissassembler.  It should compile on Linux/Solaris and Windows.
...
/*
 * Class:     sun_jvm_hotspot_hsdis_Disassembler
 * Method:    load_library
 * Signature: (Ljava/lang/String;)L
 */
JNIEXPORT jlong JNICALL Java_sun_jvm_hotspot_hsdis_Disassembler_load_1library(JNIEnv * env,
                                                                           jclass disclass,
                                                                           jstring jrepath_s,
                                                                           jstring libname_s) {
  uintptr_t func = 0;
 ...
 * Class:     sun_jvm_hotspot_hsdis_Disassembler
 * Method:    decode
 * Signature: (Lsun/jvm/hotspot/hsdis/InstructionVisitor;J[BILjava/lang/String;)V
 */
JNIEXPORT void JNICALL Java_sun_jvm_hotspot_hsdis_Disassembler_decode(JNIEnv * env,
                                                                      jobject dis,
                                                                      jobject visitor,
                                                                      jlong startPc,
                                                                      jbyteArray code,
  ...
  denv.handle_event = (*env)->GetMethodID(env, disclass, "handleEvent",
                                          "(Lsun/jvm/hotspot/hsdis/DisassemblyVisitor;Ljava/lang/String;J)J");
  ...
  denv.raw_print = (*env)->GetMethodID(env, disclass, "rawPrint",
                                       "(Lsun/jvm/hotspot/hsdis/DisassemblyVisitor;Ljava/lang/String;)V");
  if ((*env)->ExceptionOccurred(env)) {
    return;
  }

  /* decode the buffer */
  decode_instructions_virtual(startPc,
                              startPc + end - start,
                              (unsigned char*)start,
                              end - start,
